...
public class GemmedSwordItem extends SwordItem {

    public GemmedSwordItem(ToolMaterial material) {
        super(material, 9, -2.4f, new Settings());
    }

    @Override
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {

        if((ToolItem) this == ModItems.ROUGH_NETHERITE_SWORD) {
