...
public class GemmedAxeItem extends AxeItem {

    public GemmedAxeItem(ToolMaterial material) {
        super(material, 11, -3.0f, new Settings());
    }

    @Override
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {

        if((ToolItem) this == ModItems.ROUGH_NETHERITE_AXE) {
