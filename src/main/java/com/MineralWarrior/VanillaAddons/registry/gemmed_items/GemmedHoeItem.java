...
public class GemmedHoeItem extends HoeItem {

    public GemmedHoeItem(ToolMaterial material) {
        super(material, 1, 0.0f, new Settings());
    }

    @Override
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {

        if((ToolItem) this == ModItems.ROUGH_NETHERITE_HOE) {
